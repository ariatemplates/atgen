...
var readlineInterface = require('./readlineInterface'), colors = require('colors'), 	// npm install colors
rl = readlineInterface.rl, prefix = "atgen>", prefixLength = prefix.length;
