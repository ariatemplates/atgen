...
Aria.classDefinition({
	...
	$css : ["aria.widgets.css." + aria.widgets.AriaSkinInterface.getSkinName() + ".SortIndicator"],
	/**
	...
	$prototype : {
		...
		_setIconPrefix : function () {
			this._cfg._iconSet = aria.widgets.AriaSkin.scSortIndicator[this._cfg.sclass].iconset;
			this._cfg._iconPrefix = aria.widgets.AriaSkin.scSortIndicator[this._cfg.sclass].iconprefix;
		},
