...
var fs = require('fs'), util = require('util'), utility = require('./utility'), folders = require('./generators/folders'),
...
function generate (args) {
	...
	if (process.platform === 'win32') {
		folders.generateFoldersWin(proj, changes);
	} else {
		folders.generateFoldersUnix(proj, changes);
	}
