...
(function () {
	...
	Aria.classDefinition({
		...
		$events : {
			// the follwing two events are listened to by the AriaTemplatesBridge object of AriaJSP in order to disable
			// all keymaps defined in the AriaJSP part of the application
			"modalPopupPresent" : {
