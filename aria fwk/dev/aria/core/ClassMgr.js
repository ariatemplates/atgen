...
Aria.classDefinition({
	...
	$events : {
		/**
		 * Raised in the listener of the 'complete' event raised by the appropriate classLoader. This event has been
		 * added mainly for the sake of the AriaTemplatesBridge class of AriaJSP
		 * @event classComplete
		 */
		"classComplete" : {
