...
Aria.classDefinition({
	...
	$dependencies : ["aria.core.Sequencer", "aria.jsunit.TestCase"],
	...
	$prototype : {
		...
		_createTest : function (classpath) {
			var testInstance;
			try {
				testInstance = Aria.getClassInstance(classpath);
		...
		/**
		 * If the NewTestRunner is used, runtime errors are preserved in order to display them in the test runner.
		 * This can help to debug crashes that prevented the test from completing correctly
