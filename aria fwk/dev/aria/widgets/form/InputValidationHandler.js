...
Aria.classDefinition({
	...
	$dependencies : ['aria.DomEvent', 'aria.utils.Dom', 'aria.popups.Popup', 'aria.widgets.container.Div', 'aria.templates.Layout'],
	...
	$prototype : {
		...
		/**
		 * Raised when the viewport is resized. Needed to fix the position
		 * of the popup after the resize.
		 * @param {Object} evt
		 */
