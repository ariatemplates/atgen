...
(function () {
	...
	Aria.classDefinition({
		...
		$constructor : function (evt) {
			 ...
			 * @name aria.DomEvent.hasStopPropagation
			 * @type Boolean
			 */
			 ...
			 */
			this.preventDefault = !domEventCopy && isIE8orLess ? function (stopPropagation) {
			 ...
			 * @method
			 */
			this.stopPropagation = !domEventCopy && isIE8orLess ? function () {
