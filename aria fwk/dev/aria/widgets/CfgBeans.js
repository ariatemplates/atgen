 ...
 */
/**
 * @class aria.widgets.CfgBeans Configuration Beans associated to the Aria Templates Widgets
 */
Aria.beanDefinitions({
	$package : "aria.widgets.CfgBeans",
	$description : "Definition of the JSON beans used by the aria widgets",
	$namespaces : {
	...
	$beans : {
		...
		"InputCfg" : {
			...
			$properties : {
				...
				"fieldWidth" : {
					$type : "json:Integer",
					$description : "Width of the field itself - if negative, the value is considered as unset",
					$default : -1
				},
				"hideLabel" : {
					$type : "json:Boolean",
