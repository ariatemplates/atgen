...
(function () {
	 ...
	 * @class aria.widgets.controllers.SelectBoxController
	...
	Aria.classDefinition({
		...
		$dependencies : ['aria.DomEvent', 'aria.utils.Json',
				'aria.widgets.controllers.reports.DropDownControllerReport'],
		$onload : function () {
		...
		$prototype : {
			...
			/**
			 * Loops through the options in the list and checks to see if the first x number of characters is the same
			 * as what have been entered in the Select Box
