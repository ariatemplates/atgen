...
Aria.classDefinition({
	...
	$prototype : {
		...
		asyncRequest : function (req) {
			...
			// TODO: enforce the check (when backward compatibility is removed)
		...
		_asyncRequest : function (arg) {
			...
			if (method == "POST" && this.useDefaultPostHeader) {
				this._initHeader('Content-Type', this.defaultPostHeader);
			}
