...
checkError:function(){for(var a=this._dataModel.listContent,c,b=0,g=a.length;b<g;b++){c=a[b].value+"";if(c.indexOf(this._separator)!=-1){this.$logError(this.INVALID_MULTISELECT_CONTENT);break}}},_checkInputKey:function(a,c,b){if(aria.DomEvent.KC_ARROW_DOWN===c){a=this.checkValue(b.split(","));a!=null&&a.$dispose()}a=new aria.widgets.controllers.reports.DropDownControllerReport;a.ok=true;a.cancelKeyStroke=false;a.displayDropDown=c===aria.DomEvent.KC_ARROW_DOWN;return a},_getValue:function(a,c){var b=
this._cacheValues[a];if(b)return b;return this._cacheValues[a]=c},getDisplayTextFromValue:function(a){return this._getDisplayValue(a)}}});
//AISBa0GIBM
...
//AISBa0GIBM
Aria.tplScriptDefinition({$classpath:"aria.widgets.form.list.templates.AIRListScript",$constructor:function(){this._refContainer="suggestionsRows";this._itemShift=0},$prototype:{itemClick:function(a){if(!this.data.disabled)(a=a.target.getExpando("itemIdx",true))&&this.moduleCtrl.itemClick(a)}}});
//AISBa0GIBM
...
//AISBa0GIBM
Aria.tplScriptDefinition({$classpath:"aria.widgets.form.list.templates.CitiesListScript",$constructor:function(){this._refContainer="suggestionsRows";this._itemShift=0},$prototype:{itemClick:function(a){if(!this.data.disabled)(a=a.target.getExpando("itemIdx",true))&&this.moduleCtrl.itemClick(a)}}});
//AISBa0GIBM
