...
var generateFoldersWin = function generateFoldersWin (proj, changes) {
...
var generateFoldersUnix = function generateFoldersUnix (proj, changes) {
	// create the project path
	if (proj.module.path != "") {
		mkdirp.sync(proj.module.path);
	} else {
...
exports.generateFoldersWin = generateFoldersWin;
exports.generateFoldersUnix = generateFoldersUnix;