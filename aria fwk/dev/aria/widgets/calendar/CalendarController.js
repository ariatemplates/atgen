...
(function () {
	...
	Aria.classDefinition({
		...
		$dependencies : ['aria.widgets.Template', 'aria.utils.Date', 'aria.widgets.calendar.CfgBeans', 'aria.utils.environment.Date'],
		$onload : function () {
		...
		$prototype : {
			...
			init : function (data, cb) {
				...
				if (settings.firstDayOfWeek == null) { // compare to null because 0 is a valid value
					settings.firstDayOfWeek = dateUtils.firstDayOfWeek;
				}
