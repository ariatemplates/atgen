...
Aria.classDefinition({
	...
	$css : ["aria.widgets.css." + aria.widgets.AriaSkinInterface.getSkinName() + ".DatePicker",
			"aria.widgets.css." + aria.widgets.AriaSkinInterface.getSkinName() + ".Calendar",
	...
	$prototype : {
		...
		_applyCalendarCfg : function (property, targetCfg) {
			...
			targetCfg[property] = (typeof cfg[calendarProp] != 'undefined') ? cfg[calendarProp] : skinObj[calendarProp];
		},
